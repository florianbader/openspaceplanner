...
export class InternationalizationService {
     ...
     * @param localeCode The locale code. Defaults to english.
     * @param apiVersion
    ...
    public getTranslations(
        ...
        if (localeCode === null || localeCode === undefined) {
            throw new Error(
                'Required parameter localeCode was null or undefined when calling getTranslations.',
            );
        }
        ...
        let localVarPath = `/api/i18n/translations/${this.configuration.encodeParam({ name: 'localeCode', value: localeCode, in: 'path', style: 'simple', explode: false, dataType: 'string', dataFormat: undefined })}`;
